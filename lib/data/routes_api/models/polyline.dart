...
/// Encapsulates an encoded polyline and a GeoJSON LineString.
@JsonSerializable()
class Polyline {
  ...
  /// Specifies a polyline using a flexible Struct format for GeoJSON LineString.
  /// (https://tools.ietf.org/html/rfc7946#section-3.1.4)
  final Map<String, dynamic>? geoJsonLinestring;
